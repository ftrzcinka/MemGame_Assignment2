...
export default function MemCards({moveCounter, setMoveCounter, completion, setCompletion }) {
    ...
    const [cards, setCards] = useState([
        { id: 0, num: 0, name: 'MountainTop', status: '', img: 'https://moodyrahman.com/files/filip/EldenRing_img1.jpg' },
        { id: 0, num: 1, name: 'MountainTop', status: '', img: 'https://moodyrahman.com/files/filip/EldenRing_img1.jpg' },
        { id: 1, num: 2, name: 'Capital', status: '', img: 'https://moodyrahman.com/files/filip/EldenRing_img2.jpg' },
        { id: 1, num: 3, name: 'Capital', status: '', img: 'https://moodyrahman.com/files/filip/EldenRing_img2.jpg' },
        { id: 2, num: 4, name: 'FarumAzula', status: '', img: 'https://moodyrahman.com/files/filip/EldenRing_img3.jpg' },
        { id: 2, num: 5, name: 'FaramaAzula', status: '', img: 'https://moodyrahman.com/files/filip/EldenRing_img3.jpg' },
